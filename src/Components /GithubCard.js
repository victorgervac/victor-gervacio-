  ...
  return(
    ...
    <div class="card">
      <div>
        ...
        <p class="svg-icon"> Written in<a title="Python" target="_blank" rel="noopener noreferrer">
        <svg viewBox="0 0 24 24" width="1em" height="1em">
          ...
          <div class="eq-div-flex">
        <a href="https://github.com/aashutoshrathi/awesome-bashrc" aria-label="Source Code" title="Source Code" rel="noopener noreferrer" target="_blank">
          <span class="title">
            &lt;/&gt;
          </span>
            Code
